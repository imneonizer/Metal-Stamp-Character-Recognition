...
class my_recognizer():
    def find(image_to_rec):
        ...
        def work(digit_img):
            ...
            try:
                npaClassifications = np.loadtxt("recognition/alpha/classifications_for_questions.txt", np.float32)                  # read in training classifications
            except:
            ...
            try:
                npaFlattenedImages = np.loadtxt("recognition/alpha/flattened_images_for_questions.txt", np.float32)                 # read in training images
            except:
